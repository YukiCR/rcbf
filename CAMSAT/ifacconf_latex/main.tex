...
% More specificially, given the mission described in natural language, LLMs are capable of generating the priority parameters above to modify the satellite swarm behavior.
...
% where satellites move to their diametrically opposite positions. 
...
\begin{figure}[!t]
   ...
   \newcommand{\rightClip}{0bp}
   \centering
   \subfloat[$T_1 = 204.5\mathrm{s}$]{\includegraphics[width=0.9\linewidth, trim = \leftClip{} \lowerClip{} \rightClip{} \upperClip{}, clip]{llm1.png} \label{fig:llm1}} \\
   \subfloat[$T_1 = 295.5\mathrm{s}$]{\includegraphics[width=0.9\linewidth, trim = \leftClip{} \lowerClip{} \rightClip{} \upperClip{}, clip]{llm2.png} \label{fig:llm2} } \\
   \subfloat[$T_1 = 321.5\mathrm{s}$]{\includegraphics[width=0.9\linewidth, trim = \leftClip{} \lowerClip{} \rightClip{} \upperClip{}, clip]{llm3.png} \label{fig:llm3} } 
