...
From {\figurename} \ref{fig:llm1} to {\figurename} \ref{fig:llm1}, satellite 1 experienced more and more control modification from the safety filter, which increased the curvature of the satellite 1's trajectory and therefore increased $T_1$ from $204.5\mathrm{s}$ to $321.5\mathrm{s}$.
